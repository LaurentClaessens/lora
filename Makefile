# This is my old one that I still use to compile Lora.
...
UnitTests:UnitTests.cpp testing.o HashTable.h CommandLine.o GitRepository.o
	LC_ALL=C g++  -std=c++11 UnitTests.cpp  -o UnitTests CommandLine.o GitRepository.o  testing.o /usr/lib/i386-linux-gnu/libboost_filesystem.so -lboost_filesystem -lboost_system 
